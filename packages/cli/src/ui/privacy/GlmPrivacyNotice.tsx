  ...
  return (
    <Box flexDirection="column" marginBottom={1}>
      ...
      <Text color={theme.text.primary}>
        By connecting a GLM API key from Z.AI<Text color={theme.text.link}>[1]</Text>,
        you agree to the applicable service terms
        <Text color={theme.status.error}>[2]</Text> and privacy policy
        <Text color={theme.status.success}>[3]</Text> provided by Z.AI.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        <Text color={theme.text.link}>[1]</Text> https://docs.z.ai/guides/llm/glm-4.7
      </Text>
      <Text color={theme.text.primary}>
